...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.rangeHighlightColor = custBBDDFF,
    ...
    this.todayDecoration = const BoxDecoration(
      color:  Color.fromARGB(255, 250, 91, 120),
      shape: BoxShape.rectangle,
      borderRadius: BorderRadius.all(Radius.circular(10)),
    ),
    ...
    this.outsideTextStyle = const TextStyle(color: custAEAEAE),
    this.outsideDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.disabledTextStyle = const TextStyle(
        color: Color.fromARGB(255, 212, 212, 212), fontSize: 13),
    this.disabledDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.holidayTextStyle = const TextStyle(color: custC6BC0),
    this.holidayDecoration = const BoxDecoration(
      border:  Border.fromBorderSide(
         BorderSide(color: cust9FA8DA, width: 1.4),
      ),
      shape: BoxShape.circle,
    ),
    this.weekendTextStyle = const TextStyle(color: cust5A5A5A),
